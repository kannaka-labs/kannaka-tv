...
const DAYPARTS = [
  ...
  },
  {
    ...
    mood: 'streetlevel',
    rotation: ['city-desk', 'on-the-shelf', 'the-board', 'city-desk', 'now-on-the-radio'],
    carriageEvery: 3,
  },
  {
    key: 'prime',
    ...
    mood: 'feature',
    rotation: ['feature', 'on-the-shelf', 'city-desk', 'feature', 'consciousness-now'],
    carriageEvery: 4,
  },
  {
    key: 'late-signal',
    ...
    mood: 'strange',
    rotation: ['consciousness-now', 'dream-digest', 'the-long-wave', 'on-the-shelf'],
    carriageEvery: 4,
  },
];
